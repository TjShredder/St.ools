	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 2,
					"fontname" : "Verdana",
					"patching_rect" : [ 442.0, 213.0, 128.0, 33.0 ],
					"fontsize" : 11.0,
					"numinlets" : 1,
					"id" : "obj-1",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "multiple sends~ with setable parameter. Internaly the name is parameter1_x.\rThe second parameter determines the number of inputs.",
					"linecount" : 4,
					"fontname" : "Verdana",
					"patching_rect" : [ 186.0, 60.0, 242.0, 60.0 ],
					"fontsize" : 11.0,
					"numinlets" : 1,
					"id" : "obj-32",
					"numoutlets" : 0
