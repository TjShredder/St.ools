	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 350.0, 347.0, 30.0, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 350.0, 318.0, 100.0, 20.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 375.0, 53.0, 20.0 ],
					"text" : "pgmout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 381.0, 100.0, 20.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.0, 284.0, 239.0, 20.0 ],
					"text" : "@big 1 will activate the return and tab keys"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 37.0, 319.0, 57.0 ],
					"text" : "knotein is ment as a replacement for notein. it will combine a Midi notein with a keytom to let you play with the computer keyboard. This can be deactivated in case the real keyboard is attached..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 73.0, 334.0, 245.0, 35.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 308.5, 375.0, 123.0, 375.0 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 112.5, 330.0, 308.5, 330.0 ],
					"source" : [ "obj-19", 1 ]
				}
