...
,
		...
		"bgcolor" : [ 0.8, 0.678288, 0.588551, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 271.0, 43.0, 95.0, 20.0 ],
					"text" : "sprintf set %s_"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 271.0, 67.0, 50.0, 20.0 ],
					"text" : "receive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 239.0, 15.0, 83.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 94.0, 4.0, 82.0, 21.0 ],
					"varname" : "St.Menu[1]"
				}
...
,
					"patching_rect" : [ 65.5, 515.5, 70.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 65.5, 486.5, 70.0, 20.0 ],
					"text" : "mynamber"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 545.5, 122.0, 33.0 ],
					"text" : "St.MenuSend Xfadr VideoIn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 153.0, 95.0, 20.0 ],
					"text" : "sprintf set %s_"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 177.0, 50.0, 20.0 ],
					"text" : "receive"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 4.0, 82.0, 21.0 ],
					"varname" : "St.Menu"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 67.5, 417.5, 36.5, 417.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 92.0, 510.5, 126.0, 510.5 ],
					"source" : [ "obj-59", 1 ]
				}
