{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 105.0, 796.0, 629.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 105.0, 796.0, 629.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 555.0, 145.0, 20.0 ],
					"text" : "St.MenuSend Tape ADIn"
				}
...
,
					"patching_rect" : [ 38.0, 54.0, 47.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 85.0, 70.0, 18.0 ],
					"text" : "active $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 43.752083, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 48.0, 36.0, 18.0 ],
					"text" : "next"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 66.0, 202.0, 65.0, 20.0 ],
					"text" : "route dur"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 43.752083, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 448.0, 131.0, 62.0, 20.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 45.0, 122.0, 20.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 433.0, 90.0, 20.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 407.0, 90.0, 20.0 ],
					"text" : "loadmess 127"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 23.0, 34.0, 20.0 ],
					"rounded" : 8.0,
					"tabs" : [ "play" ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 98.0, 3.0, 29.0, 20.0 ],
					"rounded" : 8.0,
					"tabs" : [ "cue" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 183.0, 481.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 3.0, 35.0, 20.0 ],
					"rounded" : 8.0,
					"tabs" : [ "open" ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 40.0, 23.0, 87.0, 20.0 ],
					"rounded" : 8.0,
					"tabs" : [ "stop", "continue" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 236.543732, 422.898254, 24.0, 113.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 129.543732, 3.898254, 24.0, 113.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 656.197693, 468.322845, 120.0, 20.0 ],
					"text" : "t seek b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 729.277588, 523.690125, 47.0, 20.0 ],
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 729.277588, 499.200745, 36.0, 20.0 ],
					"text" : "float"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 656.197693, 548.179443, 93.0, 20.0 ],
					"text" : "pack seek 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "route cue set loop menu level"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 39.0, 4.0, 61.0, 18.0 ],
					"varname" : "tbox"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.0, 43.752083, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 68.0, 121.0, 48.0 ],
					"text" : "00:00",
					"varname" : "sh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 684.346008, 179.774277, 69.0, 20.0 ],
					"text" : "prep open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 448.102661, 106.119339, 62.0, 20.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 448.102661, 82.824234, 83.0, 20.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 38.0, 10.0, 47.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 363.5, 80.0, 75.5, 80.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-68", 0 ],
					"hidden" : 0,
					"midpoints" : [ 374.178711, 111.0, 75.5, 111.0 ],
					"source" : [ "obj-52", 6 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 0 ],
					"hidden" : 0,
					"midpoints" : [ 658.039124, 382.0, 246.043732, 382.0 ],
					"source" : [ "obj-8", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-62", 0 ],
					"hidden" : 0,
					"midpoints" : [ 605.839172, 314.0, 246.614075, 314.0 ],
					"source" : [ "obj-8", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-68", 0 ],
					"hidden" : 0,
					"midpoints" : [ 640.63916, 190.0, 75.5, 190.0 ],
					"source" : [ "obj-8", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"hidden" : 0,
					"midpoints" : [ 47.5, 352.0, 246.614075, 352.0 ],
					"source" : [ "obj-82", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 93.0, 115.0, 417.0, 115.0, 417.0, 78.0, 608.903015, 78.0 ],
					"source" : [ "obj-85", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 1 ],
					"hidden" : 0,
					"midpoints" : [ 75.5, 300.0, 56.0, 300.0, 56.0, 466.0, 755.777588, 466.0 ],
					"source" : [ "obj-9", 0 ]
				}
