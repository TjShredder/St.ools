	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 491.0, 145.967743, 44.0, 20.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 516.0, 121.0, 39.0, 20.0 ],
					"text" : "* 12."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.069763, 209.967743, 39.0, 20.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.990723, 75.0, 84.0, 20.0 ],
					"text" : "r #1Octave"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.990723, 34.0, 87.0, 20.0 ],
					"text" : "r #1NoiseDyn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.990723, 34.0, 84.0, 20.0 ],
					"text" : "r #1OscDyn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 805.0, 242.0, 107.0, 20.0 ],
					"text" : "*~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 604.0, 242.0, 96.0, 20.0 ],
					"text" : "*~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 805.0, 183.0, 93.0, 47.0 ],
					"text" : "funenv~ parent::noisef parent::noisep"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "", "int" ],
					"patching_rect" : [ 604.0, 183.0, 82.0, 47.0 ],
					"text" : "funenv~ parent::oscf parent::oscp"
				}
...
,
					"patching_rect" : [ 892.534912, 34.0, 80.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"default_fontname" : "Verdana",
						"fontsize" : 11.0,
...
,
					"patching_rect" : [ 681.432556, 34.0, 86.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"default_fontname" : "Verdana",
						"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.990692, 34.0, 84.0, 20.0 ],
					"text" : "r #1RelFreq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 380.520935, 550.849487, 37.0, 20.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 363.302307, 145.967743, 98.0, 20.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.069763, 82.946236, 157.0, 20.0 ],
					"text" : "unpack 1 1 0. 0."
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 326.569763, 141.0, 500.5, 141.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 418.569763, 110.419357, 344.569763, 110.419357 ],
					"source" : [ "obj-50", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 372.569763, 106.419357, 216.709305, 106.419357 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-76", 0 ],
					"hidden" : 0,
					"midpoints" : [ 372.569763, 106.973114, 613.5, 106.973114 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-77", 0 ],
					"hidden" : 0,
					"midpoints" : [ 372.569763, 106.973114, 814.5, 106.973114 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 1 ],
					"hidden" : 0,
					"midpoints" : [ 271.027893, 94.129036, 344.569763, 94.129036 ],
					"source" : [ "obj-56", 2 ]
				}
