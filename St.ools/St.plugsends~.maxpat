...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 69.0, 107.0, 60.0, 20.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.0, 226.0, 98.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.0, 77.0, 48.0, 20.0 ],
					"text" : "route~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 226.0, 101.0, 73.0 ],
					"text" : "sprintf script replace sendR newex 120 140 80 196617 plugsend~ %sR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 226.0, 97.0, 73.0 ],
					"text" : "sprintf script replace sendL newex 40 140 80 196617 plugsend~ %sL"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 334.0, 320.0, 74.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 125.0, 140.0, 74.0, 33.0 ],
					"text" : "plugsend~ ---R",
					"varname" : "sendR"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 140.0, 74.0, 33.0 ],
					"text" : "plugsend~ ---L",
					"varname" : "sendL"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 78.5, 132.0, 210.5, 132.0 ],
					"source" : [ "obj-15", 0 ]
				}
