...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.0, 474.0, 76.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.0, 498.0, 76.0, 20.0 ],
					"text" : "receive"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.0, 546.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.0, 546.0, 25.0, 25.0 ]
				}
...
,
					"patching_rect" : [ 349.5, 378.0, 75.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontsize" : 11.0,
						"globalpatchername" : "",
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 185.5, 403.0, 28.0, 20.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.5, 448.0, 38.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.5, 498.0, 62.5, 18.0 ],
					"text" : "Huber"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 185.5, 378.0, 74.0, 20.0 ],
					"text" : "delay 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.5, 523.0, 99.0, 20.0 ],
					"text" : "prepend symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 229.0, 474.0, 116.0, 20.0 ],
					"restore" : [ "Huber" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.5, 304.0, 40.0, 18.0 ],
					"text" : "recall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 162.5, 270.0, 65.0, 20.0 ],
					"text" : "delay 500"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 162.5, 210.0, 85.0, 20.0 ],
					"text" : "t b clear b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 309.5, 117.5, 195.0, 20.0 ],
					"text" : "t l l 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.5, 350.0, 115.0, 20.0 ],
					"text" : "s #1Sender"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 463.0, 474.0, 111.0, 20.0 ],
					"text" : "sprintf set %sR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.0, 474.0, 110.0, 20.0 ],
					"text" : "sprintf set %sL"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 293.5, 350.0, 131.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 463.0, 498.0, 111.0, 20.0 ],
					"text" : "plugreceive~ ---R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 350.0, 498.0, 110.0, 20.0 ],
					"text" : "plugreceive~ ---L"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 195.0, 548.0, 287.25, 548.0, 287.25, 341.0, 303.0, 341.0 ],
					"source" : [ "obj-34", 0 ]
				}
